...
const Education: React.FC = () => {
  ...
  return (
    <div className="my-16">
      <h2 className="font-bold text-6xl mb-32 w-full text-center md:text-6xl sm:text-3xl xs:text-3xl md:mb-16 transform-z-0">Education</h2>

      <div ref={ref} className="w-[75%] mx-auto relative lg:w-[90%] md:w-full">
        <motion.div style={{scaleY: scrollYProgress}} 
        className="absolute justify-between left-9 top-0 w-[4px] h-full bg-black origin-top md:w-[2px] md:left-[30px] xs:left-[20px] dark:bg-red-600 dark:shadow-3xl" />
